...
def test_azimuthnn_class():
    ...
    try:
        ...
        azimuth = AzimuthNN(query_arg=test_obj, eval_batch_size=32)
        ...
        assert False, "test_azimuthnn_class: Failed to import AzimuthNN from panhumanpy"
    except Exception as e:
        assert False, f"test_azimuthnn_class: Error running AzimuthNN on test data: {e}"
...
def test_azimuthnn_base_with_h5ad():
    ...
    try:
        ...
        assert isinstance(inference_outputs, dict), (
            "test_azimuthnn_base_with_h5ad: Inference outputs should be " "a dictionary"
        )
        ...
        assert isinstance(processed_outputs, dict), (
            "test_azimuthnn_base_with_h5ad: Processed outputs should be " "a dictionary"
        )
        ...
        assert False, f"test_azimuthnn_base_with_h5ad: Error testing with h5ad: {e}"
...
def test_annotate_core_with_h5ad():
    ...
    try:
        ...
        expected_keys = ["azimuth_object", "embeddings_dict", "umap_dict", "cells_meta"]
        for key in expected_keys:
        ...
        assert False, f"test_annotate_core_with_h5ad: Error testing with h5ad: {e}"
...
def test_embeddings_and_umap_with_h5ad():
    ...
    try:
        ...
        azimuth = AzimuthNN(query_arg=test_file, eval_batch_size=32)
        ...
        assert isinstance(embeddings, np.ndarray), (
            "test_embeddings_and_umap_with_h5ad: Embeddings should be a " "numpy array"
        )
